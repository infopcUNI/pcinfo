      ...
      <section className="py-12 bg-gray-100 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6">
            ...
            <img src={ imageB } alt="Enfoque Funcional" className="mt-4 mx-auto rounded-lg shadow-md" />
          </div>
          ...
          <div>
            ...
            <img src={ imageC } alt="Enfoque Estructural" className="mt-4 mx-auto rounded-lg shadow-md" />
          </div>
        </div>
      </section>
    </div>
